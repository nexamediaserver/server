...
/// </summary>
public sealed class AnalyzeItemPayload
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AnalyzeItemPayload"/> class.
    /// </summary>
    /// <param name="success">Whether the request succeeded.</param>
    /// <param name="error">Optional error message.</param>
    public AnalyzeItemPayload(bool success, string? error = null)
    {
