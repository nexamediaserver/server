...
/// </summary>
public sealed class RefreshMetadataPayload
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RefreshMetadataPayload"/> class.
    /// </summary>
    /// <param name="success">Whether the request succeeded.</param>
    /// <param name="error">Optional error message.</param>
    public RefreshMetadataPayload(bool success, string? error = null)
    {
