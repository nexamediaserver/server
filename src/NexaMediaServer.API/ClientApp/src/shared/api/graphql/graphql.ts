...
export type Item = Node & {
  ...
  parentThumbnailUrl: Scalars['URL']['output']
  ...
  viewedLeafCount: Scalars['Int']['output']
...
export type ItemFilterInput = {
  ...
  /** Gets the parent thumbnail URL of the metadata item. */
  parentThumbnailUrl?: InputMaybe<UrlOperationFilterInput>
  /** Gets the parent title of the metadata item. */
  ...
  /** Gets the last playback position offset (milliseconds) for the current user. */
  viewOffset?: InputMaybe<IntOperationFilterInput>
  /** Gets the number of viewed leaf items in the metadata item. */
  viewedLeafCount?: InputMaybe<IntOperationFilterInput>
  /** Gets the year the metadata item was released. */
...
export type LibrarySection = Node & {
   ...
   *
   * **Returns:**
   * A queryable used by HotChocolate to create a connection.
   */
...
export type ContentSourceAllQueryVariables = Exact<{
...
export type ContentSourceAllQuery = {
  __typename?: 'Query'
  librarySection?: {
    __typename?: 'LibrarySection'
    id: string
...
>
export const ContentSourceAllDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ContentSourceAll' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  ContentSourceAllQuery,
  ContentSourceAllQueryVariables
>
