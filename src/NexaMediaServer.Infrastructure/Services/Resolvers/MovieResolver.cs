...
/// </summary>
public class MovieResolver : ItemResolverBase<Movie>
{
    ...
    /// <inheritdoc />
    public override Movie? Resolve(ItemResolveArgs args)
    {
    ...
    private static Movie CreateDiscMovie(
    ...
    private static Movie CreateFileMovie(
        ItemResolveArgs args,
        string title,
