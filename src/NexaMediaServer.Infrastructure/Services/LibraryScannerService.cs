...
public partial class LibraryScannerService : ILibraryScannerService
{
    ...
    private readonly IEnumerable<IItemResolver<MetadataBaseItem>> itemResolvers;
    ...
    public LibraryScannerService(
        ...
        IEnumerable<Resolvers.IItemResolver<MetadataBaseItem>> itemResolvers,
    ...
    private async Task PerformScanAsync(LibraryScan scan, CancellationToken cancellationToken)
    {
        ...
        var insertChannel = Channel.CreateBounded<MetadataBaseItem>(
            new BoundedChannelOptions(1024)
            {
                FullMode = BoundedChannelFullMode.Wait,
                SingleReader = true,
