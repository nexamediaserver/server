...
namespace NexaMediaServer.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260108083329_AddOriginalSortOrderToPlaylistGeneratorItem")]
    partial class AddOriginalSortOrderToPlaylistGeneratorItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexaMediaServer.Core.Entities.CustomFieldDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("ApplicableMetadataTypes")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("[]");
            ...
            modelBuilder.Entity("NexaMediaServer.Core.Entities.DetailFieldConfigurationOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("DisabledCustomFieldKeys")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("[]");

                    b.Property<string>("DisabledFieldTypes")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("[]");

                    b.Property<string>("EnabledFieldTypes")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("[]");

                    b.Property<string>("FieldGroupAssignmentsJson")
                        .HasColumnType("TEXT");

                    b.Property<string>("FieldGroupsJson")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("MetadataType", "LibrarySectionId")
                        .IsUnique();

                    b.ToTable("DetailFieldConfigurationOverrides");
                });
            ...
            modelBuilder.Entity("NexaMediaServer.Core.Entities.ExternalIdentifier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("MetadataItemId", "Provider")
                        .IsUnique();

                    b.HasIndex("Provider", "Value");
            ...
            modelBuilder.Entity("NexaMediaServer.Core.Entities.PlaylistGeneratorItem", b =>
                {
                    ...
                    b.Property<int>("OriginalSortOrder")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NexaMediaServer.Core.Entities.TranscodeJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("EnableToneMapping")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("FfmpegProcessId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("Protocol")
                        ...
                        .HasMaxLength(16)
                        .HasColumnType("TEXT")
                        .HasDefaultValue("dash");

                    b.Property<long?>("SeekOffsetMs")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NexaMediaServer.Core.Entities.UserDetailFieldConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UserId", "MetadataType")
                        .IsUnique();

                    b.ToTable("UserDetailFieldConfigurations");
                });
            ...
            modelBuilder.Entity("NexaMediaServer.Core.Entities.UserHubConfiguration", b =>
                {
                    ...
                    b.HasIndex("UserId", "Context", "LibrarySectionId", "MetadataType")
                        .IsUnique();
