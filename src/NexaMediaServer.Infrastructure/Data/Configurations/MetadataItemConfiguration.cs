...
public class MetadataItemConfiguration : IEntityTypeConfiguration<MetadataItem>
{
    ...
    public void Configure(EntityTypeBuilder<MetadataItem> builder)
    {
        ...
        // Indexes for hub queries (recently added, recently released, etc.)
        builder.HasIndex(e => e.CreatedAt);
        builder.HasIndex(e => e.ReleaseDate);
        builder.HasIndex(e => e.Year);

        // Composite indexes for common hub query patterns
        builder.HasIndex(e => new { e.LibrarySectionId, e.CreatedAt });
        builder.HasIndex(e => new { e.LibrarySectionId, e.ReleaseDate });
        builder.HasIndex(e => new { e.MetadataType, e.CreatedAt });
        builder.HasIndex(e => new { e.MetadataType, e.ReleaseDate });
        builder.HasIndex(e => new { e.ParentId, e.MetadataType });
