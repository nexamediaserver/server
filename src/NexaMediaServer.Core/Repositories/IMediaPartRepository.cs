...
public interface IMediaPartRepository
{
    ...
    /// <summary>
    /// Soft-deletes a media part by file path (sets DeletedAt timestamp).
    /// </summary>
    /// <param name="part">The file path of the media part to soft-delete.</param>
    /// <returns>The number of rows affected.</returns>
    Task<int> SoftDeleteByFilePathAsync(string part);

    /// <summary>
    /// Soft-deletes media parts by a collection of file paths using chunked/bulk operations.
    /// </summary>
    /// <param name="filePaths">The file paths to soft-delete.</param>
    /// <param name="cancellationToken">A cancellation token.</param>
    /// <returns>The number of rows soft-deleted.</returns>
    Task<int> SoftDeleteByFilePathsAsync(
